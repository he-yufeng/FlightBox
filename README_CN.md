...
flightbox audit <run-id> --strict   # CI 门禁：policy 过滤后仍有命中则退出码 1
```
...
FlightBox 是我做的 LLM 可靠性工具之一，下面几个路子相近：
...
- **[PromptDiff](https://github.com/he-yufeng/PromptDiff)** — 改完这版 prompt 到底变好还是变坏？用 LLM 裁判做语义比对，在 CI 里把关。
